...
class TestWelcomeToApi(ApiTestCase):
    def setUp(self):
        ...
        self.url = '/{}'.format(API_PREFIX)  # TODO these are all '//v2/' but should be '/v2/' - but 91/97 tests passed
...
class TestNodeList(ApiTestCase):
    def setUp(self):
        ...
        self.url = '/{}nodes/'.format(API_PREFIX)
...
class TestNodeFiltering(ApiTestCase):
    ...
    def test_get_one_project_with_exact_filter_logged_in(self):
        url = "/{}nodes/?filter[title]=Project%20One".format(API_PREFIX)
    ...
    def test_get_some_projects_with_substring_logged_in(self):
        url = "/{}nodes/?filter[title]=Two".format(API_PREFIX)
    ...
    def test_get_only_public_or_my_projects_with_filter_logged_in(self):
        url = "/{}nodes/?filter[title]=Project".format(API_PREFIX)
    ...
    def test_alternate_filtering_field_logged_in(self):
        url = "/{}nodes/?filter[description]=Three".format(API_PREFIX)
    ...
    def test_incorrect_filtering_field_logged_in(self):
        ...
        url = '/{}nodes/?filter[notafield]=bogus'.format(API_PREFIX)
...
class TestNodeCreate(ApiTestCase):
    ...
    def test_creates_project_creates_project_and_sanitizes_html(self):
        ...
        assert_equal(res.status_code, 201)
        url = '/{}nodes/{}/'.format(API_PREFIX, project_id)
...
class TestNodeDetail(ApiTestCase):
    def setUp(self):
        ...
        self.public_url = '/{}nodes/{}/'.format(API_PREFIX, self.public_project._id)
        self.private_url = '/{}nodes/{}/'.format(API_PREFIX, self.private_project._id)
...
class TestNodeUpdate(ApiTestCase):
    ...
    def test_update_project_sanitizes_html_properly(self):
        ...
        url = '/{}nodes/{}/'.format(API_PREFIX, project._id)
...
class TestNodeContributorList(ApiTestCase):
    ...
    def setUp(self):
        ...
        self.private_url = '/{}nodes/{}/contributors/'.format(API_PREFIX, self.private_project._id)
        self.public_project = ProjectFactory(is_public=True, creator=self.user)
        self.public_url = '/{}nodes/{}/contributors/'.format(API_PREFIX, self.public_project._id)
...
class TestNodeContributorFiltering(ApiTestCase):
    ...
    def test_filtering_node_with_only_bibliographic_contributors(self):
        ...
        base_url = '/{}nodes/{}/contributors/'.format(API_PREFIX, self.project._id)
        # no filter
    ...
    def test_filtering_node_with_non_bibliographic_contributor(self):
        ...
        base_url = base_url = '/{}nodes/{}/contributors/'.format(API_PREFIX, self.project._id)
...
class TestNodeRegistrationList(ApiTestCase):
    def setUp(self):
        ...
        self.project.save()
        self.private_url = '/{}nodes/{}/registrations/'.format(API_PREFIX, self.project._id)

        self.public_project = ProjectFactory(is_public=True, creator=self.user)
        self.public_registration_project = RegistrationFactory(creator=self.user, project=self.public_project)
        self.public_project.save()
        self.public_url = '/{}nodes/{}/registrations/'.format(API_PREFIX, self.public_project._id)
...
class TestNodeChildrenList(ApiTestCase):
    def setUp(self):
        ...
        self.private_project_url = '/{}nodes/{}/children/'.format(API_PREFIX, self.project._id)

        self.public_project = ProjectFactory(is_public=True, creator=self.user)
        self.public_project.save()
        self.public_component = NodeFactory(parent=self.public_project, creator=self.user, is_public=True)
        self.public_project_url = '/{}nodes/{}/children/'.format(API_PREFIX, self.public_project._id)
...
class TestNodeFilesList(ApiTestCase):
    ...
    def setUp(self):
        ...
        self.private_url = url = '/{}nodes/{}/files/'.format(API_PREFIX, self.project._id)
        ...
        self.public_url = '/{}nodes/{}/files/'.format(API_PREFIX, self.public_project._id)
    ...
    def test_returns_node_files_list(self, mock_waterbutler_request):
        ...
        url = '/{}nodes/{}/files/?path=%2F&provider=osfstorage'.format(API_PREFIX, self.project._id)
        res = self.app.get(url, auth=self.basic_auth)
...
class TestNodePointerDetail(ApiTestCase):
    ...
    def setUp(self):
        ...
        self.private_url = '/{}nodes/{}/pointers/{}'.format(API_PREFIX, self.private_project._id, self.pointer._id)
        ...
        self.public_url = '/{}nodes/{}/pointers/{}'.format(API_PREFIX, self.public_project._id, self.public_pointer._id)
...
class TestDeleteNodePointer(ApiTestCase):
    ...
    def setUp(self):
        ...
        self.private_url = '/{}nodes/{}/pointers/{}'.format(API_PREFIX, self.project._id, self.pointer._id)
    ...
    def test_deletes_private_node_pointer_logged_in_non_contributor(self):
        url = '/{}nodes/{}/pointers/'.format(API_PREFIX, self.project._id)
